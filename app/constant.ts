...
export const REQUEST_TIMEOUT_MS = 60 * 60 * 1000; // 60 minutes for file-chat
...
export const SAAS_CHAT_URL = "https://zyinfo.pro/file-chat/";
export const SAAS_CHAT_UTM_URL =
  "https://zyinfo.pro/file-chat/?utm_source=nextchat";
